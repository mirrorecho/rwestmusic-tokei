...
def get_cycle_music():
    ...
    music.add_cycle(bubble_type=Evening, flags=["evening_1_a","evening","free"], rehearsal_mark="F")
    music.add_cycle(bubble_type=Evening, flags=["evening_1_b","evening","free"])
    # dusk
    music.add_cycle(bubble_type=Dusk1, flags=["dusk_1","free"], rehearsal_mark="G")
    ...
    # #
    # music.add_cycle(bubble_type=WadoSolo, flags=["solo_1","free"], rehearsal_mark="L")
