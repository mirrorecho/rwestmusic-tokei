...
# QUESTION... does it make more sense to inherit from Voice here??
...
class Arrangement:
    ...
    # would it make sense to use instrumenttools.InstrumentInventory here?
    parts = None # OrderedDict()

    output_path = None # "/home/randall/Code/mirrorecho/rwestmusic-tokei"

    name = None # "full-score"

    def __init__(self, name="full-score", project="rwestmusic", output_path="/home/randall/Code/mirrorecho", title="New Score"):
