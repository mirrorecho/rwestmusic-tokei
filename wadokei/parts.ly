...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Flutes"
  \score {
      \new StaffGroup <<
     \fluteOneStaff
     \fluteTwoStaff
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Oboes"
  \score {
      \new StaffGroup <<
     \oboeOneStaff
     \oboeTwoStaff
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Clarinets"
  \score {
      \new StaffGroup <<
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Bassoons"
  \score {
      \new StaffGroup <<
     \bassoonOneStaff
     \bassoonTwoStaff
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Horns-1-2"
  \score {
      \new StaffGroup <<
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Horns-3-4"
  \score {
      \new StaffGroup <<
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Trumpets"
  \score {
      \new StaffGroup <<
     \trumpetOneStaff
     \trumpetTwoStaff
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Trombones"
  \score {
      \new StaffGroup <<
     \tromboneOneStaff
     \tromboneTwoStaff
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Tuba"
  \score {
     \tubaStaff
     \header { piece = "Tuba" }
      \layout {
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.Bass"
  \score {
      \bassStaff
     \header { piece = "Bass" }
      \layout {
...
%%{---------------------------------------------------------------------------
\book {
  \bookOutputName "RandallWest-Wadokei.TAIKO"
  \score {
      \taikoStaves
     \header { piece = "Taiko" }
      \layout {
